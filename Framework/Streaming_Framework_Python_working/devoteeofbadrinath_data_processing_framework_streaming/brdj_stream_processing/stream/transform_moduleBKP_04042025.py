...
def transform_data(
    ...
    #spark = source_df._jdf.sparkSession()
    #print("ctx.spark = ",ctx.spark)
    #print("source_df._jdf.sparkSession() = ",source_df._jdf.sparkSession())
    #print("source_df.sparkSession = ",source_df.sparkSession)
    ...
    if transformation_step == TransformationStep.NORMALISE:
        #source_df.createOrReplaceTempView("stream_df")
        #spark.sql("SHOW TABLES").show()
        #print("stream_df count: ", spark.table("stream_df").count())
