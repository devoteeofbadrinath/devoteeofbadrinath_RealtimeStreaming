...
static_data = sparkSession.read\
                        .format("csv")\
                        .option("header", "true")\
                        .load('/Users/shivammittal/Desktop/Deloitte/Streaming_Framework_Python/Streaming_Framework_Python_working/devoteeofbadrinath_data_processing_framework_streaming/Miscellaneous/SampleData/sample_account_data_corrected.csv')
...
static_data.write.jdbc(url="jdbc:mysql://localhost:3306/BRDJ_USECASE_REFERENCE_FILES",
                    table = "ACNT",
                    mode = "append",
