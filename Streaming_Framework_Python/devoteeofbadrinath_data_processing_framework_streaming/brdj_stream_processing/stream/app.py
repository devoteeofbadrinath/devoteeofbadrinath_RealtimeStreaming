...
def application_context() -> Iterator:
    ...
    logger.info(args.user_id)
    logger.info(args.workload_password)
    logger.info(args.generic_vars)
    logger.info(args.job_vars)
    logger.info(args.dag_pipeline_args)
    ...
    logger.info(user_id)
    logger.info(workload_password)
    logger.info(generic_args)
    logger.info(job_args)
    logger.info(dag_pipeline_args)
