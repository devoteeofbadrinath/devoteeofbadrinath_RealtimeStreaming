...
def main(json_config):
    ...
    # Define schema paths
    spark_schema_path = f"/app/mount/{cde_resource_name}/schema/spark/{spark_schema_name}"
    avro_schema_path = f"/app/mount/{cde_resource_name}/schema/avro/{avro_schema_name}"
    ...
    def generate_and_write_data():
        ...
        (
            ...
            .option("kafka_bootstrap.servers", kafka_bootstrap_servers)
