...
def transform_data(
    ...
    query = transformed_df.writeStream \
        .outputMode("append") \
        .format("csv") \
        .option("path", "/Users/shivammittal/Desktop/Deloitte/BOI_ODS_Python/cdpods_data_processing_framework_streaming/output") \
        .option("checkpointLocation", "/Users/shivammittal/Desktop/Deloitte/BOI_ODS_Python/cdpods_data_processing_framework_streaming/checkpointing") \
        .start()
...
def prepare_reference_data(
    ...
    for rq in config:
        ...
        logger.info("Showing the dataframe schema inside the prepare_reference_data %s",df.printSchema())
